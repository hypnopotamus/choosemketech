...
const WhyMilwaukee = ({ location }) => {
  ...
  return (
    <Layout>
      ...
      {/* <ComparisonMap /> */}
      <ThreeColumn columns={WhyMKEData.threeColumnCardsWmke} title={WhyMKEData.threeColumnHeaderText} content={WhyMKEData.threeColumnContent} background={WhyMKEData.backgroundColor} />
      <ThreeColumn columns={WhyMKEData.threeColumnCardsWmke2} title={WhyMKEData.threeColumnHeaderText2} background={WhyMKEData.backgroundColor2} />
      <div className="container">
        <ImageCopy cards={WhyMKEData.cardCollectionWmke} title={WhyMKEData.cardHeaderText} />
      </div>
