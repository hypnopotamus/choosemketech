...
const TechScene = ({ location }) => {
  ...
  return (
    <Layout>
      ...
      <ThreeColumn columns={TechPageData.threeColumnCardsMts} title={TechPageData.threeColumnHeaderText} background={TechPageData.backgroundColor} />
      <div className="container">
        <ImageCopy cards={TechPageData.contentCarouselTechScene} title={TechPageData.contentCarouselHeaderText} />
      </div>
