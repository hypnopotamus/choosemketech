                    ...
                    <div className="card job-card job-card--featured">
                        <div className="job-card__left">
                            ...
                            <p>
                                ...
                                architecture, design and development of software
                                to include requirements analysis, software
                                design, coding, software integration, testing,
                                debug, and maintenance. The Software Engineer is
                                responsible for independently working on a
                                project under the day-to-day… supervision of an
                                nvisia Project Manager.
                            </p>
                            ...
                            <div className="job-card__left__details">
                                ...
                                <h5>
                                    <i className="fas fa-calendar-alt"></i> Full
                                    Time
                                </h5>
                            </div>
