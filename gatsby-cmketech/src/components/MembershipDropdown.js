    ...
    return (
      <li role="menuitem" className="utilityNav__item utilityNav__item--primary utilityNav__item--members" data-ms-content="members">
        <a href="#" onClick={(e) => handleDropdownClick(e)} className="utilityNav__link utilityNav__link--primary">
          {subNavShow && (
            <>
              <i className="fas fa-times" id="membershipDropdown__close"></i>
              <span className="membershipDropdown__close">Close</span>
              <i className="fas fa-user-circle membershipDropdown__name"></i>
              <span className="membershipDropdown__name">{firstName}</span> <i className="fas fa-caret-down"></i>
            </>
          )}
          {!subNavShow && (
            <>
              <i className="fas fa-user-circle"></i>
              <span>{firstName}</span> <i className="fas fa-caret-down"></i>
            </>
          )}
        </a>
        <CandidateSubnav />
  ...
  const CandidateSubnav = () => {
    return (
      <div className="utilityNav__member__subnav--container">
        <ul onMouseLeave={() => handleMouseLeaveSubNav()} role="menubar" className={`nav__list nav__list--secondary ${subNavShow ? "showSubNav" : ""}`}>
        ...
        <a href="#" onClick={(e) => handleDropdownClick(e)} className="utilityNav__link utilityNav__link--primary">
          {subNavShow && (
            <>
              ...
              <span className="membershipDropdown__close">Close</span>
              <i className="fas fa-user-circle membershipDropdown__name"></i>
              <span className="membershipDropdown__name">{userName}</span> <i className="fas fa-caret-down"></i>
            </>
          )}
          {!subNavShow && (
            <>
              <i className="fas fa-user-circle"></i>
              <span>{userName}</span> <i className="fas fa-caret-down"></i>
            </>
          )}
        </a>
        <CompanySubnav />
